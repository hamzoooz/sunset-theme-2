...
<div class="container author-page"><h1 class="profile-header text-center">
    ...
    <div class="author-main-info">
        <div class="row ">
            <div class="col-md-3">
                <?php $avatar_arguments = array( 'class' => 'img-responsive img-thumbnail center-block avatar-class' );  echo get_avatar(get_the_author_meta('ID')  , 196 , '', '' , $avatar_arguments);  ?>
            </div>
            <div class="col-md-9">
                    ...
                    <hr> <?php 
                        if(get_the_author_meta('description')) { ?>
                            <p class="lead"> <?php the_author_meta('description') ?> </p><?php 
                        }else{
