...
function hamzoooz_add_admin_page() {
	...
	add_submenu_page('hamzoooz_sunset', 'Custome CSS', 'custome css', 'manage_options', 'hamzoooz_custome_css', 'hamzoooz_custome_css_subpage');
...
function hamzoooz_custome_css_subpage(){
	echo '<h1>hamzoooz-sunset CSS </h1>';
} 
...
function hamzoooz_add_custom_settings(){
	...
	// register_setting('all-future-group', 'all_future_suport');
	// add_settings_section('all-fututre-id', 'all future', 'hamzoooz_all_future_callback_section', 'hamzoooz_custome_contact_form_subpage');
	// add_settings_field('all-fututre-field-id', 'all future', 'hamzoooz_all_future_field_callback', 'hamzoooz_custome_contact_form_subpage', 'contact-form-id' );
