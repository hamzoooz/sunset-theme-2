...
function hamzoooz_add_admin_page() {
	...
	// add menu page 
	// /opt/lampp/htdocs/wordpress/wp-content/themes/sunset-theme-2/include/admin/assets/images/sunset-icon.png
	// add_menu_page( 'Hamzoooz Theme Options', 'hamzoooz', 'manage_options', 'hamzoooz-sunset', 'hamzoooz_theme_create_page', get_template_directory_uri() . '/img/sunset-icon.png', 110 );
